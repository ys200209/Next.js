...
//                     </p>
//                     <p>
//                         The "decision" template displays the abbreviated personality type and two choice buttons,
//                         all
//                         surrounded by a figure.
//                         Clicking a button will either expand the choice or will collapse all nodes leading from that
//                         choice.
//                     </p>
//                     <p>
//                         The "personality" template displays the personality descriptions, as the "leaf" nodes for
//                         the
//                         tree.
//                     </p>
//                 </div>
...
//         node.data.findLinksOutOf(portid).each(l => {
//             if (l.visible) {
